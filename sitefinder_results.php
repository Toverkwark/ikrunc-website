...
<html lang="en">
	...
	<body>
		<?php
			$Opdracht = "perl scripts/ReportTargetSites.pl -r " . htmlspecialchars($_POST['RefSeqID']) . " -s " . htmlspecialchars($_POST['species']) . " -n " . htmlspecialchars($_POST['NumberOfSites']) . " -f " . (htmlspecialchars($_POST['Percentage'])/100) . " -a " . htmlspecialchars($_POST['AroundStart']);
